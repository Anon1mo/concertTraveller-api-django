    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ownerId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles.Profile')),
                ('users', models.ManyToManyField(related_name='offers', to='profiles.Profile')),
            ],
        ),
        migrations.AddField(
            model_name='chat',
